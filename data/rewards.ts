...
export const rewardsSummary: RewardsSummary = {
  ...
  milestones: [
    ...
    { days: 30, reward: "Free Drink", beans: 500 },
  ],
  tier: "Bold",
  tierMax: 3000,
  nextTier: "Naise Club",
  ...
  rewards: [
    { id: "free-americano", name: "Free Americano", cost: 500, image: images.coffeeWithLogo, productSlug: "americano" },
    { id: "free-latte", name: "Free Latte", cost: 800, image: images.coffeeWithLogo, productSlug: "naise-signature-latte" },
    { id: "free-matcha", name: "Free Matcha", cost: 1000, image: images.coffeeWithLogo, productSlug: "matcha-latte" },
    { id: "free-spanish-latte", name: "Free Spanish Latte", cost: 800, image: images.coffeeWithLogo, productSlug: "spanish-latte" },
  ],
  activity: [
