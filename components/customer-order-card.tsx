...
// customer order detail (/profile/orders/[token]) — a receipt-style view, not
// the staff fulfilment screen. The customer never mutates order state here.
export function CustomerOrderCard({
  ...
  order: Order;
  delay?: number;
  // Where the card was tapped from, so the detail screen's back button can
  // return to the right place (e.g. "profile" → back to the recent-orders
  // section instead of the full orders list).
  from?: "profile";
}) {
